...
model.add(Conv1D(filters=64, kernel_size=3, activation='relu',input_shape=(n_cols,1)))
...
model.fit(X_train,y_train, epochs=10, batch_size=20, verbose=2,validation_data=(X_test, y_test))
